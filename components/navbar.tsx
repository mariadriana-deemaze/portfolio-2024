...
export function Navbar() {
	...
	return (
		<nav className="container w-full sticky top-0 z-10 pt-10 border-b border-b-orange-100 dark:border-b-[#4D2512] from-white-600/10 dark:from-teal-200/10 via-white dark:via-black to-slate-600/10 dark:to-slate-600/10 backdrop-blur-sm transition-all duration-700">
